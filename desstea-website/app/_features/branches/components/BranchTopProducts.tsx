import type { TopProduct } from "../../dashboard/services/dashboardService";
...
export default function BranchTopProducts({ products }: BranchTopProductsProps) {
  const maxRevenue = Number(products[0]?.revenue ?? 1);
